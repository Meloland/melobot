...
from melobot.utils.match import ContainMatcher, EndMatcher, FullMatcher, RegexMatcher, StartMatcher
...
async def test_matcher():
    ...
    assert await ContainMatcher(["12345", "789"], LogicMode.AND).match("123456sdf;da789as;jf")
