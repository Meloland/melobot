...
from ..typing import TYPE_CHECKING, Any, AsyncCallable, Generic, T
...
class IPCManager:
    def __init__(self, logger: BotLogger) -> None:
        self.shares: dict["Plugin", dict[str, ShareObject]] = {}
        self.handlers: dict["Plugin", dict[str, SignalHandler]] = {}
        self.logger = logger

    def add_share(self, plugin: "Plugin", obj: ShareObject) -> None:
    ...
    def get_share(self, plugin: "Plugin", id: str) -> ShareObject:
